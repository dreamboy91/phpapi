...
GROUP BY weekly_fire_safety_tbl.id";
...
LIMIT 1  ";
    ...
    public function saveAction(Request $request)
    {
         ...
         file_put_contents('weekly.txt', $request->getContent());
     ...
     /*   $DateTimeArray=array(
		   ...
		   if (isset($data['fire_renew'])!=null)
        {
            $ppsdateTime = $data['fire_renew'];
            $ppsdate =substr($ppsdateTime , 0,10);
            $parent_tbl['fire_renew']=$ppsdate;
        }
        else
        {
            $parent_tbl['fire_renew']='0000-00-00';
        }
		
			   if (isset($data['fire_validity'])!=null)
        {
            $ppsdateTime = $data['fire_validity'];
            $ppsdate =substr($ppsdateTime , 0,10);
            $parent_tbl['fire_validity']=$ppsdate;
        }
        else
        {
            $parent_tbl['fire_validity']='0000-00-00';
        }
		   if (isset($data['boiler_renew'])!=null)
        {
            $ppsdateTime = $data['boiler_renew'];
            $ppsdate =substr($ppsdateTime , 0,10);
            $parent_tbl['boiler_renew']=$ppsdate;
        }
        else
        {
            $parent_tbl['boiler_renew']='0000-00-00';
        }

	   if (isset($data['boiler_validity'])!=null)
        {
            $ppsdateTime = $data['boiler_validity'];
            $ppsdate =substr($ppsdateTime , 0,10);
            $parent_tbl['boiler_validity']=$ppsdate;
        }
        else
        {
            $parent_tbl['boiler_validity']='0000-00-00';
        }

 if (isset($data['generator_renew'])!=null)
        {
            $ppsdateTime = $data['generator_renew'];
            $ppsdate =substr($ppsdateTime , 0,10);
            $parent_tbl['generator_renew']=$ppsdate;
        }
        else
        {
            $parent_tbl['generator_renew']='0000-00-00';
        }
